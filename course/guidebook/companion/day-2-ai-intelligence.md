...
When agents work with large codebases, they can spawn **sub-agents** which have their own context for focused exploration without bloating the main context.
