...
```bash
# Build features:
You: "I want to add a delete lead feature"
You: "I want to make the dashboard UI more modern"
You: "I want to add lead filtering in the dashboard"
...
When agents work with large codebases, they can spawn **sub-agents** which have their own context for focused exploration without bloating their main context.
